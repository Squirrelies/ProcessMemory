namespace ProcessMemory.Common
{
    public enum Win32Error : int
    {
        ...
        ERROR_CLUSTER_NODE_DRAIN_IN_PROGRESS = 5962, // (0x174A) A node drain is already in progress.
        ...
        DNS_ERROR_NSEC3_INCOMPATIBLE_WITH_RSA_SHA1 = 9103, // (0x238F) NSEC3 is not compatible with the RSA-SHA-1 algorithm. Choose a different algorithm or use NSEC.
